...
public class Product3_SauceLabsBikeLight {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//a[@id='item_0_title_link']")).click();						//To Click on the hyperlink of the Product SauceLabs Backpack

...
public class Product2_SauceLabsBackpack {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//a[@id='item_4_title_link']")).click();						//To Click on the hyperlink of the Product SauceLabs Backpack
